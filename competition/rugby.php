<?php 
    ...
    $sql = "SELECT ID_Coach,PrénomCoach, NomCoach, Photo, EmailCoach FROM Coach WHERE Specialité = 'Rugby'";
...
<body>
    <header class="rugby">
        ...
        <div class="container_titre"> 
            <h1><spam class ="auto-typing_n"></spam></h1> 
        </div>
    </header>
    ...
    <script>
        let typed = new Typed('.auto-typing_n', {
            strings: ['<i><b>Rugby<b><i>'],
            typeSpeed: 150,
            backSpeed: 2000,
            onComplete: (self) => {
