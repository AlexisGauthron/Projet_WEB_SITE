<?php 
    ...
    $sql = "SELECT ID_Coach,PrénomCoach, NomCoach, Photo, EmailCoach FROM Coach WHERE Specialité = 'Collectifs'";
...
<body>
    ...
    <script>
        let typed = new Typed('.auto-typing', {
            strings: ['<i><b>Cours - Collectifs<b><i>'],
            typeSpeed: 150,
            backSpeed: 2000,
            onComplete: (self) => {
